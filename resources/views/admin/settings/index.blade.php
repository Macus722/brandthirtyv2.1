...
@section('content')
    ...
    <div class="max-w-4xl mx-auto">
        <div class="mb-10">
            <h1 class="text-3xl font-bold text-white tracking-tight">General Settings</h1>
            <p class="text-slate-500 text-sm mt-1">Manage pricing, mockups, and display configurations.</p>
        </div>
